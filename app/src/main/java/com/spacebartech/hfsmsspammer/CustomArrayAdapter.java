 ...
 *
 */
public class CustomArrayAdapter extends ArrayAdapter<Fila> implements View.OnClickListener {

    private LayoutInflater layoutInflater;

    public CustomArrayAdapter(Context context, List<Fila> objects) {
